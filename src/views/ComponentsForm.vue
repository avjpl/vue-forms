<template>
  <div>
    ...
    <form @submit.prevent="createEvent">
      ...
      <BaseInput label="Title" v-model="event.title" type="text" error="This field is required" />
...
export default {
  components: { BaseButton, BaseCheckbox, BaseRadioGroup, BaseInput, BaseSelect },
  data() {
    return {
      categories: [
        'sustainability',
